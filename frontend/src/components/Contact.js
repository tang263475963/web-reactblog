...
import logo1 from '../images/users/T.jpg'
import logo2 from '../images/users/F.jpg'
...
const Example = (props) => {
    ...
    return (
        <div className="bg-light spacer feature20 up front" >
                <Container>
                    <Row className="justify-content-center ">
                        <Col md="7" className="text-center">
                            <br/>
                        <h3>Contact <Badge color="dark">Know us</Badge>{' '}</h3>
                ...
                <Row>
                    <Col lg="6" className="text-center m-b-30">
                        ...
                        <img src={logo1} alt="img" className="img-circle" width='300' />
                        <p className="m-t-15 m-b-0"></p>
                    </Col>
                    <Col lg="6" className="text-center m-b-30">
                        <h4 className="card-title">กาญจนา กาสี</h4>
                        <h6 className="card-subtitle"><code>-</code> ปวส. 2 คอมพิวเตอร์โปรแกรมเมอร์</h6>
                        <img src={logo2} alt="img" className="img-circle" width="300" />
                        <p className="m-t-15 m-b-0"></p>
                    </Col>
                </Row>
            </Container>
